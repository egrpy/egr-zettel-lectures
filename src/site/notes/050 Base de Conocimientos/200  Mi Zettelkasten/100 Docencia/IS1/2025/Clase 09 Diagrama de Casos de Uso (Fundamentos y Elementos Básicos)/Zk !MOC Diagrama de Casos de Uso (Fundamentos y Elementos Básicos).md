...
Por ejemplo, en el contexto de un [[050 Base de Conocimientos/200  Mi Zettelkasten/100 Docencia/IS1/2025/Clase 09 Diagrama de Casos de Uso (Fundamentos y Elementos Básicos)/Zk UML - Actores - Roles - Equipo de Fútbol\|equipo de fútbol]], los actores (jugadores, entrenadores) se relacionan con el sujeto "Sistema de Gestión Deportiva" mediante casos de uso como "Planificar estrategia" o "Gestionar alineación", ilustrando cómo roles y acciones se articulan para modelar procesos colaborativos [[050 Base de Conocimientos/200  Mi Zettelkasten/100 Docencia/IS1/2025/Clase 09 Diagrama de Casos de Uso (Fundamentos y Elementos Básicos)/Zk UML - Actores - Roles - Casos de Uso - Equipo de Fútbol\|(ver integración)]]. Esta estructura conectada permite visualizar cómo las necesidades externas se traducen en operaciones concretas dentro del sistema.
