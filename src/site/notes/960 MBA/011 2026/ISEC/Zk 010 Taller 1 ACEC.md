---
{"dg-publish":true,"permalink":"/960 MBA/011 2026/ISEC/Zk 010 Taller 1 ACEC/","tags":["#definir"]}
---
...
#### Objetivos
- Validar el esquema [[960 MBA/011 2026/ISEC/Zk 011 MBA ERP Cloud Edition (ACEC)\|Zk 011 MBA ERP Cloud Edition (ACEC)]] como base de solución.
- Elicitar requerimientos **no funcionales** (seguridad, performance, disponibilidad, soporte, cumplimiento)
- Identificar requerimientos de **integración** y **puntos de dolor** del sistema / infraestructura actual
...
- 15 min – Presentación MBA ERP Cloud Edition
    ...
    - Cliente → ACEC → Capa de Administración → Aplicación multi‑tenant → BD por cliente → Gestión de Cambios → Roadmap Funcional.
...
4. **Soporte y Operación del Servicio**
    ...
    - Preguntas:
        ...
        - ¿Qué hoy hace perder más tiempo al equipo de ACEC cuando algo falla?
